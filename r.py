...
bot = telebot.TeleBot('8147144508:AAEZjvEEH_KX1qDI18D7ieJz54zAcm3My6Q')
...
def create_random_key():
    key = "AAYU-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 AAYUxDDOS!", reply_markup=markup)
